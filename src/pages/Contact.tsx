            ...
            <motion.div {...fadeUp}>
              ...
              <div className="space-y-6">
                {[
                  ...
                  { icon: Mail, label: "Email Us", value: "info@bridgedentalclinic.ng" },
              ...
              <div className="mt-10 rounded-xl overflow-hidden border border-border">
                <iframe
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3970.0!2d5.78!3d5.56!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNcKwMzMnMzYuMCJOIDXCsDQ2JzQ4LjAiRQ!5e0!3m2!1sen!2sng!4v1"
                  width="100%"
                  height="250"
                  style={{ border: 0 }}
                  allowFullScreen
